...
router.post("/send-offer-mail", async (req, res) => {
    try {
        ...
        const rateCheck = checkRateLimit(rateLimitStore.offer, ip);
        ...
        if (!selectedOption || !companyName || !email || !phone || !details) {
        ...
        registerSuccessfulRequest(rateLimitStore.offer, ip);
        ...
        console.error("OFFER ERROR:", error.message || error);
